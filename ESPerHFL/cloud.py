...
class Cloud():
    ...
    def aggregate(self, args):
        ...
        self.shared_state_dict = p_average(w=received_dict)

        return None

    def send_to_edge(self, edge,o):
        edge.receive_from_cloudserver(copy.deepcopy(self.shared_state_dict[o]))
        return None
